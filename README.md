# Train 'EasyOCR'
- In this repository, we train ['EasyOCR'](https://github.com/JaidedAI/EasyOCR) using ['공공행정문서 OCR'](https://aihub.or.kr/aihubdata/data/view.do?currMenu=115&topMenu=100&aihubDataSe=realm&dataSetSn=88) dataset from 'AI-Hub'.
